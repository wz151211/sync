...
@Data
@Document(value = "document_zhengquan_result")
public class SecurityResultVo {
    ...
    //虚假陈述揭露日
    private String disclosureDay;
    private String disclosureDayContent;

    //买入均价计算方法
    private String averagePrice;
    private String averagePriceContent;

    //投资者投资差额损失
    private String differenceLoss;
    ...
    private String approvedByContent;
    //核定文书
    private String approvedDoc;
    private String approvedDocContent;
