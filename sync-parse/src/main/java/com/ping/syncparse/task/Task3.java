...
import com.ping.syncparse.sync.c9.service.SearchService3;
...
public class Task3 {
    @Autowired
    private SearchService3 searchService;
    Criteria criteria = Criteria.where("jsonContent.s11").is("财政行政管理（财政）");
