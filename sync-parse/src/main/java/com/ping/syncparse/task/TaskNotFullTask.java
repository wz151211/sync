...
import com.ping.syncparse.sync.SyncNotFullService;
import com.ping.syncparse.sync.c140.SearchServicejb;
...
@Async*/
@Slf4j
public class TaskNotFullTask {
    @Autowired
    private SyncNotFullService searchService;
    Criteria criteria = new Criteria().orOperator(Criteria.where("jsonContent").isNull(), Criteria.where("jsonContent"));
