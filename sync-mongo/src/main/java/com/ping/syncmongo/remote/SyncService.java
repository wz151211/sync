...
import com.ping.syncmongo.local.entity.*;
import com.ping.syncmongo.local.mapper.*;
...
public class SyncService {
    ...
    public void sync() {
        ...
        List<String> ids = list.parallelStream().map(DocumentEntity::getId).collect(Collectors.toList());
