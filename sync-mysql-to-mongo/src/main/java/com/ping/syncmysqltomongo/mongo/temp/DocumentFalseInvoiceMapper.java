...
public class DocumentFalseInvoiceMapper {
    ...
    public List<DocumentFalseInvoiceEntity> findList(int pageNum, int pageSize, Criteria criteria) {
        ...
        return mongoTemplate.find(query, DocumentFalseInvoiceEntity.class);
    }

    public void save(DocumentFalseInvoiceEntity entity) {
